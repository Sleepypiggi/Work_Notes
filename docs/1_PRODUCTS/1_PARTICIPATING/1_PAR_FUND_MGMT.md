...
The above method is known as the **Backcasting** method as it involves projecting the asset share from inception of the policy. However, SAS SAP L03 allows a **simplified method** to calculate AS by **rolling forward** previously calculated AS with actual investment and claim experience.
