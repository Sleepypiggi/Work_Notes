...
!!! Note
    ...
    In Singapore, this type of variable structure known is commonly known as a **Investment Linked Policy** (ILP).

seperate account
policyholder holds all investment and inteest rate risk, higher returns

units
caclulcated daily
front end loads before units are purchased

Mnaaged directly vs othr holdings

NIF = Daily return
dividend = addittional units
